...
{
    public class Animation3d : Node3d
    {
        public OsbAnimation sprite;
        public IEnumerable<OsbAnimation> Sprites { get { yield return sprite; } }
        ...
        {
            sprite = sprite ?? segment.CreateAnimation(SpritePath, FrameCount, FrameDelay, LoopType, SpriteOrigin);
        }
